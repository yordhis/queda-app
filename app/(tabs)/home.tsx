  ...
  const hotelsData: Hotel[] = [
    {
      ...
      name: "Hotel Paraíso",
      description:
        "Un lugar perfecto para relajarse y disfrutar de la naturaleza.",
    ...
    },
    {
      ...
      description:
        "Ubicado en el corazón de la ciudad, ideal para viajeros de negocios.",
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      >
        ...
        <View className={mostrarHoteles ? "" : "hidden"}>
          {" "}
          {/* Espacio entre el form y el slider */}
