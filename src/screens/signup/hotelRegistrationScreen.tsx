  ...
  return (
    <KeyboardAvoidingView behavior="padding" style={{ flex: 1 }}>
      <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
        ...
        <FormInput label="Nombre" name="name" placeholder="Ej: Hotel Paraíso" />
        <FormInput
          label="Eslogan del Hotel"
          name="slogan"
          placeholder="Tu descanso ideal nos importa"
        />
        <FormInput
          label="Descripción"
          name="description"
        ...
        <FormInput label="RIF" name="rif" placeholder="Ej: J-12345678-9" />
